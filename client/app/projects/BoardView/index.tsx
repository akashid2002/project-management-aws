...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
  ...
  console.log("Tasks in BoardView:", id);
    ...
    >
      ...
      <div className="p-4 md:p-6">
        <div className="flex items-start justify-between">
          ...
          <button className="flex h-6 w-4 shrink items-center justify-center dark:text-neutral-500">
            <EllipsisVertical size={26} />
          </button>
        </div>
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="-spce-[6px] flex overflow-hidden">
            {task.assignee && (
              <Image
          ...
          <div className="flex items-center text-gray-500 dark:text-neutral-500">
            ...
            <span className="mr-1 text-sm dark:text-neutral-400">
              {numberOfComments}
            </span>
          </div>
        </div>
