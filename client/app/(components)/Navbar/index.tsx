    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative flex h-min w-[200px]">
          ...
          <input
            className="dark:bg-gray700 w-full rounded bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:outline-none dark:text-white dark:placeholder-white"
            type="search"
            placeholder="Search..."
          />
        </div>
      ...
      <div className="flex items-center">
        ...
        <div className="w-[0.1rem mr-5 ml-2 hidden min-h-[2em] bg-gray-200 md:inline-block"></div>
      </div>
    </div>
  );
};
